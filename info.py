...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001769437975 -1001855645227 -1002475275261 -1002411436292').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002453651327'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002463332367')) # The movie you upload in it will be deleted from the bot.
...
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/akhowtoopenlinks/34")
TUTORIAL_2 = environ.get("TUTORIAL_2", "")
TUTORIAL_3 = environ.get("TUTORIAL_3", "")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "modijiurl.com")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", '4ed9f7b048d0c13394d7799f605e51a11dfacbe6')
SHORTENER_API2 = environ.get("SHORTENER_API2", "")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", '')
SHORTENER_API3 = environ.get("SHORTENER_API3", "")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", '')
TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "75600"))
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "1600"))
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/EVX.jpg https://envs.sh/Exe.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/a_.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/FmN.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://roasted-fania-uploaderb-2a426f9e.koyeb.app/")
